...
const HOTEL_CARDS: CardItem[] = [
  {
    ...
    tags: ["Spa", "Kahvaltı Dahil", "WiFi"],
    cta: "Oda Seç",
  },
  {
    id: "h2",
    type: "hotel",
    title: "City Loft Suites",
  ...
  },
  {
    ...
    tags: ["Kayak", "Şömine", "Spa"],
    cta: "Müsaitliği Kontrol Et",
  },
  {
    id: "h5",
    type: "hotel",
    title: "Alaçatı Stone House",
    ...
    rating: 4.6,
    reviews: 920,
    badge: "Ege'nin İncisi",
    badgeColor: "#4dc4ce",
    location: "Alaçatı, İzmir",
    tags: ["Kahvaltı", "Bisiklet", "Sörf"],
    cta: "Rezervasyon Yap",
  },
  {
    id: "h6",
    ...
    description: "1892'de Orient Express yolcuları için inşa edilen efsanevi otel. Agatha Christie'nin ilham aldığı Neo-Klasik mimarisi, Dedeman restorasyon ödülleri ve Boğaz manzaralı teraslı balosalonuyla tarihin içinde yaşayın.",
...
const RESTAURANT_CARDS: CardItem[] = [
  {
    ...
    rating: 4.6,
    reviews: 3420,
    badge: "Michelin Önerisi",
    badgeColor: "#1c3d54",
    location: "Kuruçeşme, İstanbul",
    time: "12:00 – 00:00",
    tags: ["Et", "Fine Dining", "Rezervasyon"],
    cta: "Rezervasyon Yap",
  },
  {
    id: "r2",
    ...
    time: "11:00 – 22:00",
    tags: ["Türk Mutfağı", "Uygun Fiyat", "Kebap"],
    cta: "Menüyü Gör",
  },
  {
    id: "r3",
  ...
  },
  {
    ...
    time: "12:00 – 23:00",
    tags: ["Balık", "Deniz Ürünleri", "Tarihi"],
    cta: "İncele",
  },
  {
    id: "r5",
    ...
    description: "Şef Mehmet Gürs'ün imza restoranı. İstanbul'un en yüksek noktalarından birinde, çağdaş Türk mutfağını İskandinav tekniklerle harmanlayan 360 derece panoramik manzaralı gurme deneyimi.",
    ...
    location: "Beyoğlu, İstanbul",
    time: "18:30 – 23:30",
    tags: ["Füzyon", "Manzara", "Tasting Menu"],
    cta: "Rezervasyon Yap",
  },
];
...
const PRODUCT_CARDS: CardItem[] = [
  {
    ...
    description: "Nike'ın ikonik Max Air yastıklama teknolojisiyle tasarlanmış günlük spor ayakkabı. Hafif mesh üst yüzey, geniş burun bölgesi ve kaymaz dış taban ile hem sporda hem günlük kullanımda konfor sağlar.",
  ...
  },
  {
    ...
    badge: "Yeni Ürün",
    badgeColor: "#1ba3b8",
    tags: ["Laptop", "Üretkenlik", "Premium"],
    cta: "Satın Al",
  },
  {
    id: "p3",
  ...
  },
  {
    ...
    badge: "Premium",
    badgeColor: "#1c3d54",
    tags: ["Spor", "GPS", "Titanium"],
    cta: "İncele",
  },
];

// ─── Bot conversation scenarios ─────────────────────────────────────────────
type Scenario = {
  keywords: string[];
  reply: string;
  cards?: CardItem[];
...
const SCENARIOS: Scenario[] = [
  {
    ...
    cards: HOTEL_CARDS,
    cardLabel: "6 Otel Sonucunu Gör",
    panelTitle: "Önerilen Oteller",
  },
  {
    ...
    cardLabel: "5 Restoran Önerisini Gör",
    panelTitle: "Önerilen Restoranlar",
  },
  {
    ...
    cards: PRODUCT_CARDS,
    cardLabel: "4 Ürün Sonucunu Gör",
    panelTitle: "Önerilen Ürünler",
  },
  {
    ...
    cards: HOTEL_CARDS,
    cardLabel: "Bütçeye Uygun Seçenekler",
    panelTitle: "Bütçeye Uygun Seçenekler",
  },
];
...
export default function App() {
  ...
  const handleSend = useCallback((text: string) => {
    ...
    setTimeout(() => {
      ...
      const botMsg: Message = {
        ...
        timestamp: new Date(),
        hasCards: !!matched?.cards,
        cardLabel: matched?.cardLabel,
      };
      ...
      if (matched?.cards) {
        const sessionData = {
          cards: matched.cards!,
          title: matched.panelTitle || "Sonuçlar",
        };
        setCardData((prev) => ({
          ...prev,
          [botMsgId]: sessionData,
        }));
        // Auto-open panel & append to history
        setTimeout(() => {
  ...
  const handleShowCards = useCallback(
    (msgId: string) => {
      // Her zaman paneli aç ve ilgili session'a geç
  ...
  const handleClosePanel = () => {
    // Sadece kapat, session'ları ve favorileri koru
    setActiveCardMsgId(null);
    setIsPanelOpen(false);
  };
  ...
  return (
    <div className="flex w-screen overflow-hidden justify-center" style={{ height: "100dvh", background: isDark ? "#0a1720" : "#f3f4f6", transition: "background 0.3s" }}>
      <div
      ...
      >
        {/* Content panel — top on mobile, right on desktop */}
        {isPanelOpen && (
          <div
