...
const EQ_BARS = [
  { color: "rgba(255,77,109,0.7)",   delay: "0ms"   },
  { color: "rgba(255,154,60,0.7)",   delay: "85ms"  },
  { color: "rgba(247,215,0,0.7)",    delay: "170ms" },
  { color: "rgba(46,204,113,0.7)",   delay: "255ms" },
  { color: "rgba(77,196,206,0.7)",   delay: "170ms" },
  { color: "rgba(68,136,255,0.7)",   delay: "85ms"  },
];
