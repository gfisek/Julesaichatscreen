...
import {
  ...
  Moon, X as PhosphorX, Monitor, SidebarSimple,
    ...
    >
      ...
      <div className="flex items-center gap-2 overflow-hidden">
        <button
          ...
          style={{ width: "22px", height: "22px", color: textMuted, background: "transparent", border: `1px solid ${border}`, flexShrink: 0, cursor: "pointer" }}
          onMouseEnter={e => {
