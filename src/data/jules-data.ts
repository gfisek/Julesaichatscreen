  ...
  datasets: {
    ...
    restaurants: [
      ...
      },
      {
        ...
        description: "Musa Dağdeviren'in 35 yıllık tutkusu ve emeğiyle hayata geçirilen Çiya Sofrası, Kadıköy'ün kalbinde Anadolu mutfağının en özgün yorumunu sunuyor. Güneydoğu'dan Ege kıyılarına uzanan 200'den fazla yöresel tarif, mevsiminin en taze malzemeleriyle her gün hazırlanıyor.",
    ...
    products: [
      ...
      },
      {
        ...
        description: "Sony'nin amiral gemisi gürültü engelleme kulaklığı. End��stri lideri ANC teknolojisi, 30 saatlik pil ömrü ve katlanabilir tasarımıyla seyahat ve ofis kullanımı için en iyi seçenek.",
        ...
        badge: "En Çok Satan", badgeColor: "#0a6e82", tags: ["ANC", "Bluetooth", "30 Saat"], cta: "Ürünü İncele",
      },
      {
  ...
  scenarios: [
    {
      ...
      dataset: "hotels", cardLabel: "6 Otel", panelTitle: "Önerilen Oteller",
    },
    {
      ...
      dataset: "restaurants", cardLabel: "5 Restoran", panelTitle: "Önerilen Restoranlar",
    },
    {
      ...
      dataset: "products", cardLabel: "4 Ürün", panelTitle: "Önerilen Ürünler",
    },
    {
      ...
      dataset: "hotels", cardLabel: "6 Bütçeye Uygun Otel", panelTitle: "Bütçeye Uygun Seçenekler",
    },
  ],
};
